...
<template>
  <header class="flex items-center justify-between px-6 py-4 bg-gray-400 border-b-4 border-gray-900">
        ...
        >
          ...
          >
            ...
            <p class="mx-2 text-sm">
              ...
              <span class="font-bold text-indigo-400" href="#">Upload Image</span> artical . 2m
            </p>
          </a>
          <a
            href="#"
          ...
          >
            ...
            <p class="mx-2 text-sm">
              ...
              <span class="font-bold text-indigo-400" href="#">Test with TDD</span> artical . 1h
            </p>
          </a>
          <a
            href="#"
