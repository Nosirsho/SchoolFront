...
<template>
  <button
    @click="onEditClick"
    type="button"
    class="p-1 text-cyan-400 border-2 border-cyan-400 text-center hover:bg-cyan-500 hover:text-white focus:ring-2 focus:ring-cyan-300 rounded-lg text-sm text-center inline-flex items-center"
  >
    <svg
